...
Value getmininginfo(const Array& params, bool fHelp)
{
    ...
    obj.push_back(Pair("StakeReadyShares", ((uint64_t)pwalletMain->GetStakeWeight(*pwalletMain, STAKE_NORMAL))/730));
...
Value getworkex(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(-9, "CCIShare is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(-10, "CCIShare is downloading blocks...");
...
Value getwork(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "CCIShare is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "CCIShare is downloading blocks...");
