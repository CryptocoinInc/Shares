...
unsigned int nStakeMaxAge = 60 * 60 * 24 * 45;	// stake age of full weight: 45d
unsigned int nStakeTargetSpacing = 180;			// 3-minute block spacing
unsigned int nStakeTargetSpacingNEW = 180;

int64 nChainStartTime = 1409516023;
...
const string strMessageMagic = "CCIShare Signed Message:\n";
...
// Temp for halving fork issue
    ...
    bool fEnforceBIP30 = true; // Always active in CCIShare
    bool fStrictPayToScriptHash = true; // Always active in CCIShare
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CCIShare", CClientUIInterface::MSG_WARNING);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Bitcoin Mining Made Easy";
        CTransaction txNew;
		...
		txNew.strTxComment = "text:CCIShare genesis block";
        ...
        block.nVersion = 1;
        block.nTime    = 1409516023;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 612601;
        if (fTestNet)
        {
            block.nTime = 1409516020;
            block.nBits = bnProofOfWorkLimit.GetCompact();
            block.nNonce = 460672;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xc56733532b1990fe96845dbb09e8cf8b463966b87e849f79a9b100117c062d05"));
...
string GetWarnings(string strFor)
{
    ...
    if (!CLIENT_VERSION_IS_RELEASE)
        strStatusBar = _("1.6.4 BETA - Please Notify developer of any bugs or requests");
...
unsigned char pchMessageStart[4] = { 0x01, 0x02, 0x03, 0x04 };
