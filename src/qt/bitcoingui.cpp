...
{
    resize(850, 550);
    setWindowTitle(tr("Cryptocoin Inc.") + " - " + tr("Shares Client"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    overviewAction->setStatusTip(tr("Show general overview of CCIShares"));
    ...
    sendCoinsAction->setStatusTip(tr("Send shares to a CCIShares Client"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About CCIShare"), this);
    aboutAction->setStatusTip(tr("Show information about CCIShare"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for CCIShare"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CCIShare addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CCIShare addresses"));

    exportAction = new QAction(QIcon(":/icons/export"), tr("&Export..."), this);
    exportAction->setStatusTip(tr("Export the data in the current tab to a file"));
    exportAction->setToolTip(exportAction->statusTip());
    openRPCConsoleAction = new QAction(QIcon(":/icons/debugwindow"), tr("&RPC Console"), this);
    openRPCConsoleAction->setStatusTip(tr("Open RPC and diagnostic console"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    // Configure the menus
    QMenu *file = appMenuBar->addMenu(tr("&System"));
    ...
    QMenu *wallet = appMenuBar->addMenu(tr("&Client"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("CCIShare client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("CCIShare Client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CCIShare network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid CCIShare address or malformed URI parameters."),
