    ...
    model(0)
{
    ...
    ui->editTxComment->setPlaceholderText(tr("Attach a transaction comment (this information is public)"));
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a shares client address"));
#endif
